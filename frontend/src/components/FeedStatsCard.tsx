  ...
  if (error) {
    return (
      <section className="card p-4 border-red-900/60">
        <h3 className="mb-2">Feed Activity</h3>
  ...
  if (loading || !data) {
    return (
      <section className="card p-4">
        <h3 className="mb-4">Feed Activity</h3>
  ...
  return (
    <section className="card p-4">
      <div className="mb-4 flex items-center justify-between gap-3">
        <h3>Feed Activity</h3>
        <span className="terminal-panel-kicker">tweets</span>
      </div>

      <div className="mb-4 grid grid-cols-3 border border-[var(--border-primary)]">
        <div className="border-r border-[var(--border-primary)] p-3">
          <p className="text-[10px] uppercase text-[var(--text-tertiary)]">1h</p>
          <p className="text-2xl font-bold text-[var(--accent-blue)]">{data.tweets.last_1h}</p>
        </div>
        <div className="border-r border-[var(--border-primary)] p-3">
          <p className="text-[10px] uppercase text-[var(--text-tertiary)]">6h</p>
          <p className="text-2xl font-bold text-[var(--accent-blue)]">{data.tweets.last_6h}</p>
        </div>
        <div className="p-3">
          <p className="text-[10px] uppercase text-[var(--text-tertiary)]">24h</p>
          <p className="text-2xl font-bold text-[var(--accent-blue)]">{data.tweets.last_24h}</p>
        </div>
      </div>

      <div className="space-y-2">
        {categories.length === 0 ? (
          <p className="text-sm text-[var(--text-tertiary)]">No category activity yet</p>
        ) : (
